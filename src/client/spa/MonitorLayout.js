	...
	function(templates, Map){
		var MonitorLayout = Backbone.Marionette.Layout.extend({
			...
			gotPerformanceData: function(data) {
				...
				var performanceByTimeStamp = performance.dimension(function(d) { return d.timestamp; });
				...
				var selectedPerformance = performanceByTimeStamp.bottom(Infinity); // ascending order
				console.log("selectedPerformance[0]", selectedPerformance[0]);
				console.log("selectedPerformance[0]", selectedPerformance[selectedPerformance.length-1]);
